...
is not a principle. Overruled by the person whose vault it is. The objection it was
based on (a file sent from disk leaving a dangling reference) is answered by copying it in
